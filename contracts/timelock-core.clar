;; timelock-core
;; A secure smart contract for managing time-locked token releases and vesting schedules.
;;
;; This contract enables precise control over token distribution through configurable
;; timelock mechanisms, supporting complex vesting strategies and secure asset management.
